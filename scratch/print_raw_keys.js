...
async function check() {
  ...
  if (data && data.length > 0) {
    ...
    console.log('config_json top-level keys:', Object.keys(configObj));
    console.log('debugLogs exists:', !!configObj.debugLogs);
    if (configObj.debugLogs) {
      console.log('debugLogs keys:', Object.keys(configObj.debugLogs));
    }
  } else {
